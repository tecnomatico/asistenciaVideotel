 ...
 */
package co.tecnoamti.java.asistenciavideotel.vista.marcacion;

/**
 *
 * @author joel
 */
public class Marcacion extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Marcacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
